# -*- coding: utf-8 -*-
#
# eidprog documentation build configuration file, created by
...
copyright = u'2010-2018, Gert-Ludwig Ingold, Lizenz: CC BY 4.0 International'
...
html_title = u'Einführung in das Programmieren für Physiker und Materialwissenschaftler'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'Einführung in das Programmieren'
...
man_pages = [
    ('index', 'eidprog', u'eidprog Documentation',
...
texinfo_documents = [
  ('index', 'eidprog', u'eidprog Documentation',
   u'Gert-Ludwig Ingold', 'eidprog', 'One line description of project.',
   'Miscellaneous'),
]
